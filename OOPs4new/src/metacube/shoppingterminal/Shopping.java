 ...
 *
 */
public class Shopping implements Action {
	@Override
	public void performAction() {
		...
		HashMap<Integer,Product> product =handleFile.getList("ProductList.csv");
		HashMap<Integer,ProductPromotion>hashProductPromotion=handleFile.getProductPromo("ProductPromo.csv");
		List <OrderPromotion> orderPromotionList=handleFile.getOrderPromo("OrderPromo.csv");
