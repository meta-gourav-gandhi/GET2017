...
public class FileHandling {
	 ...
	 */
	public HashMap<Integer, Product> getList(String filepath) {
	 ...
	 */
	public List<OrderPromotion> getOrderPromo(String filepath) {
	 ...
	 */
	public HashMap<Integer, ProductPromotion> getProductPromo(String filepath) {
