...
CREATE TABLE `title_author` (
  ...
  CONSTRAINT `fk_title_id` FOREIGN KEY (`title_id`) REFERENCES `titles` (`title_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `title_author` VALUES (1,1),(2,2);
...
-- Dump completed on 2017-09-06 16:59:39
